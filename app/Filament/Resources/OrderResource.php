        ...
        return $form
            ->schema([
                ...
                Forms\Components\Repeater::make('cartItems')
                    ...
                    ->columnSpan('full')
                    ->reactive() 
                    ->afterStateUpdated(fn (callable $set, callable $get) => self::updateTotalPrice($set, $get)), // Update when repeater changes
                ...
                Forms\Components\TextInput::make('total_price')
                    ...
                    ->disabled()
                    ->reactive()
                    ->afterStateUpdated(fn (callable $set, callable $get) => self::updateTotalPrice($set, $get)) // Ensures updates trigger recalculations
                    ->columnSpan(2),
